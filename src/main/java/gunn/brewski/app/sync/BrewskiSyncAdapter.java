...
public class BrewskiSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    private static final String[] NOTIFY_WEATHER_PROJECTION = new String[] {
            BrewskiContract.WeatherEntry.COLUMN_WEATHER_ID,
            BrewskiContract.WeatherEntry.COLUMN_MAX_TEMP,
            BrewskiContract.WeatherEntry.COLUMN_MIN_TEMP,
            BrewskiContract.WeatherEntry.COLUMN_SHORT_DESC
    };
    ...
    private void notifyWeather() {
        ...
        if ( displayNotifications ) {
            ...
            if (System.currentTimeMillis() - lastSync >= DAY_IN_MILLIS) {
                ...
                Uri weatherUri = BrewskiContract.WeatherEntry.buildWeatherLocationWithDate(locationQuery, System.currentTimeMillis());
